													...
													<div class="step-content">
														<div class="row-fieldsets">
															...
															<fieldset>
																...
																<input type="tel" name="telephone"  class="required d8val_inttelephone_mobile_line_opt" id="telephone" />
															</fieldset>  
															<div class="checkbox-container">
																<div class="checkbox-clickable"> 
																	<input type="checkbox" name="terms-check"  id="terms-check" />
																</div>
																<label for="terms-check">By clicking this box you agree to our <a target="__blank" href="/docs/life-privacy.pdf">Privacy Policy</a> and <a  target="__blank" href="/docs/life-terms.pdf">terms and conditions</a>.</label>
															</div>
														</div> 
