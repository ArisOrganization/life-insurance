...
function watchFiles(cb) {
    ...
    gulp.watch(["./style/sass/*.sass", "./style/sass/*/*.sass"], gulp.series(css));
...
exports.package = gulp.task('package', gulp.series(clean,  gulp.parallel(css, js, copy_assets), build_package));
