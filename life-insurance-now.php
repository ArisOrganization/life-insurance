    ...
    <div class='page-main-content'>
              ...
              <div class="hero-left" data-aos="fade-up" data-aos-duration="800">
                <div class="inner-left-content">
                  ...
                  <div class="content-container">
                    ...
                    <button class="clickable clickable-new">GET MY QUOTE</button>
      ...
      <section class='three-steps'>
        <div class='container'>
          ...
          <div class='row'>
            <div class='col-12'>
              <button class="cta clickable clickable-new">GET MY QUOTE</button>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class='row'>
            <div class='col-12'>
              ...
              <div class="cta-container">
                <button class="cta cta-alt clickable clickable-new">GET MY QUOTE</button>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div class="range-item-content">
                      ...
                      <div>
                        <p class="range-item-desc">
                          ...
                          <a class="cta cta-primary clickable clickable-new">Get Your FREE Insurance Quote Now</a>
                        </p>
